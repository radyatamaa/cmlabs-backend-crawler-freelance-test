...
func Limit(requestLimit int, windowLength time.Duration, options ...Option) beego.FilterChain {
...
func LimitByIP(requestLimit int, windowLength time.Duration) beego.FilterChain {
